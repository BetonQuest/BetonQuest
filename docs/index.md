...
<div class="betonquest-flex-container">
  <div class="betonquest-flex-item">
    ...
    <a href="./Tutorials/Overview/" title="Get started with our tutorials"
...
| <p>Feature</p>           |                 [BetonQuest][L1]                 | [Quests][L2]<span> PikaMug</span> | [Quests][L3]<span> LMBishop</span> |     [BeautyQuests][L5]     |  [TypeWriter][L6]  |      [BattlePass][L7]      |       [ProQuest][L8]       |
|--------------------------|:------------------------------------------------:|:---------------------------------:|:----------------------------------:|:--------------------------:|:------------------:|:--------------------------:|:--------------------------:|
| Spigot Rating            |                    Loading...                    |            Loading...             |             Loading...             |         Loading...         |     Loading...     |         Loading...         |         Loading...         |
| Free                     |                :white_check_mark:                |        :white_check_mark:         |         :white_check_mark:         |     :white_check_mark:     | :white_check_mark: |       :x:  (14.99€)        |       :x:  (14.99$)        |
...
| Version Support          |                 1.20.6 - 26.1.2                  |           1.8 - 26.1.2            |             1.8 - 1.21             |        1.17 - 1.21         |        1.21        |         1.17-1.21          |        1.7 - 26.1.2        |
| Integrated Plugins       | @snippet:constants:totalIntegratedPluginsNumber@ |                12                 |                 30                 |             30             |         3          |             40             |             2              |
| BetonQuest integration   |                                                  |    :material-check-bold: [^5]     |                :x:                 |            :x:             |        :x:         |            :x:             |            :x:             |
| In-game Editor           |                     :x: [^6]                     |         Chat & GUI(Paid)          |                :x:                 |            GUI             |        :x:         |            GUI             |            GUI             |
| Web Editor               |                       :x:                        |                :x:                |                :x:                 |            :x:             | :white_check_mark: |            :x:             |            :x:             |
| Database Support         |                  SQLite & MySQL                  |               MySQL               |            File & MySQL            |           MySQL            |        File        |        File & MySQL        |       SQLite & MySQL       |
| BungeeCord Support       |                :white_check_mark:                |                :x:                |         :white_check_mark:         |            :x:             |        :x:         |     :white_check_mark:     |            :x:             |
| Organized File Structure |                :white_check_mark:                |                :x:                |                :x:                 |            :x:             |        :x:         |            :x:             |            :x:             |
| <p>Unique Features</p>   |                                                  |                                   |                                    |                            |                    |                            |                            |
| Multi-Path Conversations |                :white_check_mark:                |                :x:                |                :x:                 | :material-check-bold: [^3] | :white_check_mark: |            :x:             |            :x:             |
| Quest Journal            |                :white_check_mark:                |        :white_check_mark:         |                :x:                 |            :x:             |        :x:         |     :white_check_mark:     |            :x:             |
...
| Clientside NPCs          |                :white_check_mark:                |                :x:                |                :x:                 |            :x:             | :white_check_mark: |            :x:             |            :x:             |
| Clientside Players       |                :white_check_mark:                |                :x:                |                :x:                 |            :x:             |        :x:         |            :x:             |            :x:             |
| Clientside Holograms     |                :white_check_mark:                |                :x:                |                :x:                 |     :white_check_mark:     | :white_check_mark: |            :x:             |            :x:             |
| Clientside Particles     |                :white_check_mark:                |                :x:                |                :x:                 | :material-check-bold: [^4] | :white_check_mark: |            :x:             |            :x:             |


Use this table with caution, it might be outdated (last update <span class="bq-highlight">**19th of May 
2026**</span>).
...
See the full list of integrations [here](Documentation/Reference/Integrations-List/index.md).
