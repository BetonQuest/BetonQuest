...
[`variable`](../Scripting/Building-Blocks/Objectives-List.md#variable) objective.
...
This command relates to active [variable objectives](../Scripting/Building-Blocks/Objectives-List.md#variable).
