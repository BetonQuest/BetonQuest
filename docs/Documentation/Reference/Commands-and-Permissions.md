...
[`variable`](Objectives-List.md#variable) objective.
...
* `/rpgmenu open <menu(ID)> [player]` - Opens a menu for you or another player.
  [Open conditions](../Advanced/Menus/index.md#general-menu-settings) will be ignored when using this command.
...
Have a look at the [menu settings](../Advanced/Menus/index.md#general-menu-settings) for more information.
...
If `recursive` is added [nested packages](../Basics/Packages-&-Templates.md#__tabbed_1_3) or templates will be downloaded while by default they
...
This command relates to active [variable objectives](Objectives-List.md#variable).
