...
[variable condition](Conditions-List.md#variable) or the 
[password objective](Objectives-List.md#password) to match player names, item names, etc. These expressions are
