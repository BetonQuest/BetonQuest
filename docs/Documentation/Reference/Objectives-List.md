...
To allow spaces use [quoting](../Basics/Quoting-&-YAML.md#quoting) syntax.
...
| _date_       | 17.04.2022 16:14                      | Shows the date the objective is completed at using the config's [`date_format` setting](Plugin-Config.md#date_format-the-format-of-dates). |
...
| Parameter         | Syntax                                | Default Value          | Explanation                                                                                                                                                                                                                                                                                                                                        |
|-------------------|---------------------------------------|------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| _item_            | [Quest Item](../Advanced/Items.md) | :octicons-x-circle-16: | The quest item that must be enchanted.                                                                                                                                                                                                                                                                                                             |
...
|-----------------|--------------------------------------------------------------------------------------------------------|------------------------|-------------------------------------------------------------------------------------------------------------------------------------|
| _Click Type_    | `right`, `left` or `any`                                                                               | :octicons-x-circle-16: | What type of click should be handled                                                                                                |
| _Entity Type_   | [EntityType type](https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/EntityType.html) or `any` | :octicons-x-circle-16: | The entity which must be clicked                                                                                                    |
...
You can modify the stages with the [stage action](Actions-List.md#stage) and check it's state with the [stage 
condition](Conditions-List.md#stage).
...
If you don't define the amount, the objective will run indefinitely until you complete it with the [objective action]
(Actions-List.md#objective).
