...
[variable condition](Building-Blocks/Conditions-List.md#variable) or the 
[password objective](Building-Blocks/Objectives-List.md#password) to match player names, item names, etc. These expressions are
