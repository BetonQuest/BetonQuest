...
Parties are defined directly in the [party action](./Building-Blocks/Actions-List.md#party-run-actions-for-the-party)
or the [party condition](./Building-Blocks/Conditions-List.md#party-check-conditions-for-party).  
