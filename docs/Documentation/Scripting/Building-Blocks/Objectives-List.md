...
| _ignorecancel_  | Keyword (`ignorecancel`)                             | Objective won't progress | Allows the objective to progress, even if the event is cancelled by the Server. (For example player is not allowed to build)                                                                                                                                              |
