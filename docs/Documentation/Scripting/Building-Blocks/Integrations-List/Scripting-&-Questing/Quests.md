...
__Syntax__: `quest <name> [check-requirements]`  
__Description__: Will start the quest for the player.
...
__Syntax__: `quest <name>`  
__Description__: Whether the player has completed the specified quest.

The first and only argument is the name of the quest.
