...
A list of all actions that act differently can be found in the [`runIndependent`](Building-Blocks/Actions-List.md#runindependent-run-actions-as-independent) docs.
...
To do this you can use the [`runforall`](Building-Blocks/Actions-List.md#runforall-run-for-online-players) action. It will run the given actions for all players on the server. 
