...
Read the [updater](../Reference/Plugin-Config.md#updater-the-updater-settings) section to correctly set up the Auto-Updater.
...
!!! warning "Updating BetonQuest"
    ...
    From 1.X to 2.X you should read the [Migration-1-2](Migrations/Migration-1-2.md) guide.  
    From 2.X to 3.X you should read the [Migration-2-3](Migrations/Migration-2-3.md) guide.
...
A backup can also be created manually by running the [backup command](../Reference/Commands-and-Permissions.md#commands).
