...
## Creating a menu
To create a new menu just create a `menus` section in any file inside a [quest package](../../Basics/Packages-&-Templates.md).
...
|                   `bind`                    | `bind: "openMenuItem"`                      | Clicking with this [quest item](../Items.md) in hand will open the menu. You can create this item in the `items` section of your package. Defining different clicks is supported. |
...
|:----------------------------------:|:-------------------------:|------------------------------------------------------------------------------------------------------------------------------------------------------|
|              `amount`              |       `amount: 30`        | The size of the stack that will be displayed in the menu. [Placeholders](../../Reference/Placeholders-List.md) are supported.        |
...
Both [color codes](https://minecraft.wiki/w/Formatting_codes) and [placeholders](../../Reference/Placeholders-List.md) are supported and carried into the next line, if not overridden.
