...
You can configure the interval which checks the conditions with the [`player_update_interval`](../Reference/Plugin-Config.md#hider-entity-hider-settings) setting.
