...
A list of all actions that act differently can be found in the [`runIndependent`](../Reference/Actions-List.md#runindependent) docs.
...
To do this, you can use the [`runforall`](../Reference/Actions-List.md#runforall) action. It will run the given actions for all players on the server. 
