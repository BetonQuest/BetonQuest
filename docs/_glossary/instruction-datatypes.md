...
*[Number]: Any number representation that may also have decimal places.
*[String]: Any concatenation of characters.
*[List]: A list is a sequence of values separated by commas.
