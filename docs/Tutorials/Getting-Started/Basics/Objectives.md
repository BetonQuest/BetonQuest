...
!!! tip "Faster Fishing"
    ...
    ``` YAML title="1.21+"
    /give @p fishing_rod[custom_name={"text":"Instant Fishing Rod","color":"yellow","italic":false},lore=[{"text":"Instantly summons a hungry fish...","italic":false}],item_name=mrjimin,enchantments={lure:100}]
    ```
    ``` YAML title="1.20.5+"
...
objective to have a more advanced quest! More objectives can be found in the [objectives list](../../../Documentation/Reference/Objectives-List.md).
