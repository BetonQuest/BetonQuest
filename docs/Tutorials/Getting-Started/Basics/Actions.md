...
Every action type is documented in the actions list, read more about the [folder](../../../Documentation/Scripting/Building-Blocks/Actions-List.md#folder-run-multiple-actions)
and [teleport](../../../Documentation/Scripting/Building-Blocks/Actions-List.md#teleport-teleport-a-player) actions there. 
