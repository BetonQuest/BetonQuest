...
class VersionTypeBuilderTest {
    ...
    void simple_builder_builds() {
        final VersionTypeBuilder builder = VersionType.builder().finite().any("any");
        final VersionType anyType = builder.build();
    ...
    void simple_number_builder() {
        final VersionTypeBuilder builder = VersionType.builder().finite().number("number");
        final VersionType versionType = builder.build();
    ...
    void defaulting_to_correct_value() {
        ...
        final VersionTypeBuilder builder = VersionType.builder().finite().number("version")
    ...
    void semantic_type_builder() {
        final VersionTypeBuilder builder = VersionType.builder()
                .finite().number("major")
                .opt()
    ...
    void match_exact_type_builder() {
        final VersionTypeBuilder builder = VersionType.builder().finite().exact("version", "1.2.3");
        final VersionType versionType = builder.build();
    ...
    void fail_on_impossible_type() {
        final VersionTypeBuilder builder = VersionType.builder().any("any").finite().any("any2");
        final VersionType versionType = builder.build();
    ...
    void fail_on_non_finite_builder() {
        final VersionTypeBuilder builder = VersionType.builder().any("any");
    ...
    void fail_on_finite_empty_builder() {
        final VersionTypeBuilder builder = VersionType.builder().finite();
    ...
    void fail_on_empty_optional_builder_with_token_before() {
        final VersionTypeBuilder builder = VersionType.builder().any("any").opt();
    ...
    void fail_on_closing_non_empty_non_finite_optional_builder() {
        final VersionTypeBuilder builder = VersionType.builder().any("any").opt().any("any2").opt();
