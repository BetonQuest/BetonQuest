...
class VersionParserTest {
    ...
    void parse_valid_versions(final DefaultVersionType type, final String version) {
    ...
    void parse_invalid_versions(final DefaultVersionType type, final String version) {
