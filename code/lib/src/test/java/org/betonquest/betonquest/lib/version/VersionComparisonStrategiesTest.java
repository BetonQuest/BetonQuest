...
class VersionComparisonStrategiesTest {
    ...
    private static final VersionType SIMPLE_VERSION_TYPE = VersionType.builder()
            .number("major")
            .dot().number("minor")
            .opt()
    ...
    private static final String[] SIMPLE_VERSIONS = {
            "1.2.3", "1.3", "1.3.5-SNAPSHOT", "1.3.5", "1.4.1", "2.0", "3.0-SNAPSHOT", "3.0.1-SNAPSHOT", "3.1"
    };

    private static final String[] SIMPLE_VERSIONS_2 = {
            "1.2.3", "1.3", "1.4.5-SNAPSHOT", "1.5.5", "1.6.1", "2.7", "1.8-SNAPSHOT", "3.9.1-SNAPSHOT"
    };

    private static final String[] SIMPLE_VERSIONS_3 = {
            "1.2.3", "1.3", "1.3.5-SNAPSHOT", "1.3.6", "1.3.8-SNAPSHOT", "1.4.1", "2.0", "3.0-SNAPSHOT", "3.0.1-SNAPSHOT", "3.1"
    };
    ...
    void ensure_versions_are_sorted_default() {
        final Version[] versions = generateVersions(SIMPLE_VERSIONS);
    ...
    void ensure_versions_are_sorted_only_compare_minor() {
        final Version[] versions = generateVersions(SIMPLE_VERSIONS_2);
        for (int i = 0; i < versions.length - 1; i++) {
    ...
    void ensure_versions_are_sorted_only_compare_compare_until_patch() {
        final Version[] versions = generateVersions(SIMPLE_VERSIONS_3);
        for (int i = 0; i < versions.length - 1; i++) {
    ...
    void version_mismatch_should_fail() {
        final Version version = VersionParser.parse(SIMPLE_VERSION_TYPE, "1.1.0");
        final Version otherVersion = VersionParser.parse(VersionType.SIMPLE_SEMANTIC_VERSION, "1.1.0");
