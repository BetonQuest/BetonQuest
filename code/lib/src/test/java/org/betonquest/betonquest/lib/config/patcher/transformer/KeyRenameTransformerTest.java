...
class KeyRenameTransformerTest extends TransformersFixture {
    ...
    void flawless() throws PatchException {
        ...
        TRANSFORMER.transform(new DefaultPatcherOptions(Map.of("oldKey", "section.test", "newKey", "section.testNew")), config);
    ...
    void flawless_on_list() throws PatchException {
        ...
        TRANSFORMER.transform(new DefaultPatcherOptions(Map.of("oldKey", "section.myList", "newKey", "section.newList")), config);
    ...
    void throws_exception_on_invalid() {
        assertThrows(PatchException.class, () -> TRANSFORMER.transform(new DefaultPatcherOptions(Map.of("oldKey", "section.invalid", "newKey", "section.testNew")), config));
    }
}
