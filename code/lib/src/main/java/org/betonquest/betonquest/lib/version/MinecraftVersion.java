...
/**
 * This class provides predefined {@link DefaultVersionType} constant for the standard Minecraft version format.
 */
public final class MinecraftVersion {

    /**
     * The {@link DefaultVersionType} for Minecraft versions.
     */
    public static final DefaultVersionType MINECRAFT_VERSION_TYPE = DefaultVersionType.builder()
            .number("major").dot()
            .finite().number("minor")
            .opt()
