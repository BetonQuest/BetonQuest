...
/**
 * A builder class for constructing {@link VersionType} instances.
 ...
 * to create an instance of {@link VersionType}.
 */
...
public class VersionTypeBuilder {
     ...
     * @return itself
     */
    @Contract(pure = true, value = "_, _, _ -> this")
     ...
     * @return itself
     */
    @Contract(pure = true, value = "_, _, _, _ -> this")
