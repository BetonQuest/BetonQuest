...
public interface BetonQuestLogger {
     ...
     * <p>
     * Don't use this method, if you can provide a {@link LogSource}.
     * Use {@link BetonQuestLogger#debug(LogSource, String, Throwable)} instead.
     *
     * @param msg    The message to log.
     ...
     * Use this for additional debug log information.
     * <p>
     * If you can provide an exception use {@link BetonQuestLogger#debug(LogSource, String, Throwable)} instead.
     *
     ...
     * Use this for additional debug log information.
     * <p>
     * If you cannot provide an exception use {@link BetonQuestLogger#debug(LogSource, String)} instead.
     *
     * @param logSource The related {@link LogSource}.
     * @param msg       The message to log.
     * @param thrown    The throwable to log.
     ...
     * <p>
     * Don't use this method, if you can provide a {@link LogSource}.
     * Use {@link BetonQuestLogger#warn(LogSource, String, Throwable)} instead.
     *
     * @param msg    The message to log.
     * @param thrown The throwable to log.
     */
     ...
     * Use this if you can provide useful information how to fix the underlying problem.
     * <p>
     * If you can provide an exception use {@link BetonQuestLogger#warn(LogSource, String, Throwable)} instead.
     *
     * @param logSource The related {@link LogSource}.
     * @param msg       The message to log.
     */
     ...
     * Use this if you can provide useful information how to fix the underlying problem.
     * <p>
     * If you cannot provide an exception use {@link BetonQuestLogger#warn(LogSource, String)} instead.
     *
     * @param logSource The related {@link LogSource}.
     * @param msg       The message to log.
     * @param thrown    The throwable to log.
     ...
     * <p>
     * Don't use this method, if you can provide a {@link LogSource}.
     * Use {@link BetonQuestLogger#error(LogSource, String, Throwable)} instead.
     *
     * @param msg    The message to log.
     * @param thrown The throwable to log.
     */
     ...
     * Usage is also allowed if you don't know how the user can fix the underlying issue.
     * <p>
     * If you can provide an exception use {@link BetonQuestLogger#error(LogSource, String, Throwable)} instead.
     *
     * @param logSource The related {@link LogSource}.
     * @param msg       The message to log.
     */
     ...
     * Usage is also allowed if you don't know how the user can fix the underlying issue.
     * <p>
     * If you cannot provide an exception use {@link BetonQuestLogger#error(LogSource, String)} instead.
     *
     * @param logSource The related {@link LogSource}.
     * @param msg       The message to log.
     * @param thrown    The throwable to log.
