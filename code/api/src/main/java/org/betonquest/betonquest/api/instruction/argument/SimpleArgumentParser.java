...
public interface SimpleArgumentParser<T> extends InstructionArgumentParser<T>, ValueParser<T> {
    ...
    @Override
    default T apply(final PlaceholderManager placeholders, final QuestPackageManager packManager, final QuestPackage pack, final String string) throws QuestException {
        return apply(string);
    }
}
