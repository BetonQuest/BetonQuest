...
public class BetonQuestPlugin extends BetonQuest {
    ...
    public void onEnable() {
        ...
        integrationService.withPolicy("1.20.6").register(this, () -> new BundledMC_1_20_6(this));
        integrationService.withPolicy("1.21.4").register(this, () -> new BundledMC_1_21_4(this));
        new BundledCompatibility(getLoggerFactory().create(BundledCompatibility.class), getPluginConfig(), this, integrationService)
                .registerCompatiblePlugins(getLoggerFactory(),
