...
public class LuckPermsPermissionAction implements PlayerAction {
    ...
    /**
     * The Constructor for the {@link LuckPermsPermissionAction}.
     *
     ...
     */
    public LuckPermsPermissionAction(final LuckPermsNodeBuilder nodeBuilder, final LuckPerms luckPermsAPI, final NodeApply nodeApply) {
