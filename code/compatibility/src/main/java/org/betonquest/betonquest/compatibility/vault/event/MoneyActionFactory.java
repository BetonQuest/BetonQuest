...
/**
 * Factory to create {@link MoneyAction}s from {@link Instruction}s.
 */
public class MoneyActionFactory implements PlayerActionFactory {
    ...
    public PlayerAction parsePlayer(final Instruction instruction) throws QuestException {
        ...
        return new MoneyAction(economy, amount, multi, givenSender, takenSender);
    }
}
