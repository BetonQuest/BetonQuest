...
public class LuckPermsActionFactory implements PlayerActionFactory {
     ...
     */
    public LuckPermsActionFactory(final LuckPerms luckPermsAPI) {
    ...
    public PlayerAction parsePlayer(final Instruction instruction) throws QuestException {
        ...
        return switch (action.toLowerCase(Locale.ROOT)) {
            case "addpermission" ->
                    new LuckPermsPermissionAction(getNodeBuilder(instruction), luckPermsAPI, NodeMap::add);
            case "removepermission" ->
                    new LuckPermsPermissionAction(getNodeBuilder(instruction), luckPermsAPI, NodeMap::remove);
            default ->
