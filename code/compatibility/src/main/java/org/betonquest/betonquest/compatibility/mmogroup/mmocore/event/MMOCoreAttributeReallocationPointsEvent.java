 ...
 */
public class MMOCoreAttributeReallocationPointsEvent implements PlayerAction {
     ...
     */
    public MMOCoreAttributeReallocationPointsEvent(final Argument<Number> amount) {
        this.amount = amount;
    }
