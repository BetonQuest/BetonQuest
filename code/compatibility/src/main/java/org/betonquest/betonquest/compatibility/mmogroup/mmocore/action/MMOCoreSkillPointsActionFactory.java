 ...
 */
public class MMOCoreSkillPointsActionFactory implements PlayerActionFactory {

    /**
     * Create a new MMO Core Action Factory.
     */
    public MMOCoreSkillPointsActionFactory() {
    }

    @Override
    public PlayerAction parsePlayer(final Instruction instruction) throws QuestException {
        final Argument<Number> amount = instruction.number().get();
        return new OnlineActionAdapter(new MMOCoreSkillPointsAction(amount));
    }
}
