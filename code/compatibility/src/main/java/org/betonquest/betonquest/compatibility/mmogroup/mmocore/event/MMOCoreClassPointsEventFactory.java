...
/**
 * Factory to create {@link MMOCoreClassPointsEvent}s from {@link DefaultInstruction}s.
 */
public class MMOCoreClassPointsEventFactory implements PlayerEventFactory {
     ...
     */
    public MMOCoreClassPointsEventFactory(final PrimaryServerThreadData data) {
        this.data = data;
    }
