...
public class MythicMobKillObjectiveFactory implements ObjectiveFactory {
    ...
    public Objective parseInstruction(final Instruction instruction) throws QuestException {
        ...
        final Variable<Number> minMobLevel = instruction.getValue("minLevel", instruction.getParsers().number(), Double.NEGATIVE_INFINITY);
        final Variable<Number> maxMobLevel = instruction.getValue("maxLevel", instruction.getParsers().number(), Double.POSITIVE_INFINITY);
