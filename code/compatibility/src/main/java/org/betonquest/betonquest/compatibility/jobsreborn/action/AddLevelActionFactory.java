...
/**
 * Factory to create {@link AddLevelAction}s from {@link Instruction}s.
 */
public class AddLevelActionFactory implements PlayerActionFactory {

    /**
     * Create a new Factory to create Can Level Conditions.
     */
    public AddLevelActionFactory() {
    }
    ...
    public PlayerAction parsePlayer(final Instruction instruction) throws QuestException {
        ...
        return new AddLevelAction(job, amount);
    }
}
