...
/**
 * Factory to create {@link SetLevelAction}s from {@link Instruction}s.
 */
public class SetLevelActionFactory implements PlayerActionFactory {

    /**
     * Create a new Factory to create Can Level Conditions.
     */
    public SetLevelActionFactory() {
    }
    ...
    public PlayerAction parsePlayer(final Instruction instruction) throws QuestException {
        ...
        return new SetLevelAction(job, amount);
    }
}
