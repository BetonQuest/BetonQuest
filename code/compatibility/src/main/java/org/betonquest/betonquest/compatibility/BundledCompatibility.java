...
import org.betonquest.betonquest.compatibility.thebrewingproject.TheBrewingProjectIntegrator;
import org.betonquest.betonquest.compatibility.thebrewingproject.TheBrewingProjectPolicies;
...
public final class BundledCompatibility {
    ...
    public void registerCompatiblePlugins(final ServicesManager servicesManager, final ProcessorDataLoader processorDataLoader) {
        ...
        register("TheBrewingProject", () -> new TheBrewingProjectIntegrator(), TheBrewingProjectPolicies.policies());
    }
}
