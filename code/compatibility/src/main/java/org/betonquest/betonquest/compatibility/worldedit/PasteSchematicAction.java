 ...
 */
public class PasteSchematicAction implements NullableAction {
     ...
     */
    public PasteSchematicAction(final Argument<Location> loc, final Argument<Number> rotation, final FlagArgument<Boolean> noAir, final Argument<File> file) {
        this.loc = loc;
