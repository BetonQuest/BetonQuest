 ...
 */
public class McMMOAddExpEventFactory implements PlayerActionFactory {
    ...
    public PlayerAction parsePlayer(final Instruction instruction) throws QuestException {
        ...
        return new OnlineActionAdapter(new McMMOAddExpEvent(skillType, exp), log, instruction.getPackage());
    }
}
