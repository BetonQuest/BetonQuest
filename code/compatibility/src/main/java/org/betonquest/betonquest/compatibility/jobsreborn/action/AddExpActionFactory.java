...
/**
 * Factory to create {@link AddExpAction}s from {@link Instruction}s.
 */
public class AddExpActionFactory implements PlayerActionFactory {

    /**
     * Create a new Factory to create Can Level Conditions.
     */
    public AddExpActionFactory() {
    }
    ...
    public PlayerAction parsePlayer(final Instruction instruction) throws QuestException {
        ...
        return new AddExpAction(job, amount);
    }
}
