...
public class ZNPCsPlusWrapper implements NpcWrapper<NpcEntry> {
     ...
     */
    public ZNPCsPlusWrapper(final NpcRegistry npcRegistry, final Argument<String> npcId) {
    ...
    @Override
    public Set<Npc<NpcEntry>> getNpcs(@Nullable final Profile profile) throws QuestException {
