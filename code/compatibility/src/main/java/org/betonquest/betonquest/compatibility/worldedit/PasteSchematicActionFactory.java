...
/**
 * Factory to create {@link PasteSchematicAction}s from {@link Instruction}s.
 */
public class PasteSchematicActionFactory implements PlayerActionFactory, PlayerlessActionFactory {
     ...
     */
    public PasteSchematicActionFactory(final File folder) {
        this.folder = folder;
    }
