...
class VariableInstructionTest {
    ...
    void variableInstructionShouldThrowExceptionWhenInstructionDoesNotStartAndEndWithPercentCharacter() {
        assertThrows(QuestException.class, () -> {
            new VariableInstruction(mock(Variables.class), mock(QuestPackageManager.class),
                    questPackage, null, "instruction");
    ...
    void partsShouldBeSplitByDot() throws QuestException {
        final VariableInstruction instruction = new VariableInstruction(mock(Variables.class), mock(QuestPackageManager.class),
                questPackage, null, "%instruction.part1.part2%");
