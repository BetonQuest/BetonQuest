 ...
 */
public class PointAction implements PlayerAction {
     ...
     */
    public PointAction(final NotificationSender pointSender, final Argument<String> category, final Argument<Number> count,
