...
/**
 * A factory for creating Item placeholders.
 */
public class ItemPlaceholderFactory implements PlayerPlaceholderFactory, PlayerlessPlaceholderFactory {
    ...
    /**
     * Create a new Item placeholder factory.
     *
     * @param playerDataStorage the storage for player data
     */
    public ItemPlaceholderFactory(final PlayerDataStorage playerDataStorage) {
