 ...
 *
 * @param <T> kind of {@link ReadableIdentifier} that is supplied
 */
public class CompositeInstructionMetricsSupplier<T extends ReadableIdentifier> implements InstructionMetricsSupplier<T> {

    /**
     * The supplier to use for {@link ReadableIdentifier}s.
     */
     ...
     *
     * @param identifierSupplier supplier for {@link ReadableIdentifier}s
