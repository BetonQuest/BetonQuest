 ...
 */
public class PatcherOptionsImpl implements PatcherOptions {
     ...
     */
    public PatcherOptionsImpl(final Map<?, ?> options) {
    ...
    @Override
    public @Nullable Object get(final String key, @Nullable final Object defaultValue) {
        final Object object = options.get(key);
        if (object == null) {
            return defaultValue;
        }
    ...
    @Contract("_, !null -> !null")
    @Override
    public @Nullable String getString(final String key, @Nullable final String defaultValue) {
