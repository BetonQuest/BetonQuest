...
public class QuestCancelerID extends InstructionIdentifier {
     ...
     */
    public QuestCancelerID(final Variables variables, final QuestPackageManager packManager, @Nullable final QuestPackage pack, final String identifier) throws QuestException {
        super(variables, packManager, pack, identifier, "cancel", "Quest Canceler");
    }
}
