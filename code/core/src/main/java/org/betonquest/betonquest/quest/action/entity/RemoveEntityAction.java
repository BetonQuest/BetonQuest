 ...
 */
public class RemoveEntityAction implements NullableAction {
     ...
     */
    public RemoveEntityAction(final Argument<List<EntityType>> types, final Argument<Location> location, final Argument<Number> radius,
