 ...
 */
public class SetBlockEventFactory implements PlayerActionFactory, PlayerlessActionFactory {
    ...
    private NullableActionAdapter createSetBlockEvent(final Instruction instruction) throws QuestException {
        ...
        return new NullableActionAdapter(new SetBlockEvent(blockSelector, location, ignorePhysics));
    }
}
