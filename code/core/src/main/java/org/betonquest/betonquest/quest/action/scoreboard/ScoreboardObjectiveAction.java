 ...
 */
public class ScoreboardObjectiveAction implements PlayerAction {
     ...
     */
    public ScoreboardObjectiveAction(final Argument<String> objective, final Argument<Number> count, final PointType modification) {
