...
public class JournalCondition implements OnlineCondition {
     ...
     */
    private final Argument<JournalEntryIdentifier> targetPointer;
     ...
     */
    public JournalCondition(final PlayerDataStorage dataStorage, final Argument<JournalEntryIdentifier> targetPointer) {
    ...
    public boolean check(final OnlineProfile profile) throws QuestException {
        final JournalEntryIdentifier resolved = targetPointer.getValue(profile);
