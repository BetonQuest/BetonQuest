...
public class MenuClickEvent extends MenuEvent implements Cancellable {
     ...
     */
    public MenuClickEvent(final Profile who, final MenuIdentifier menu, final int slot, final MenuItemIdentifier itemId, final ClickType clickType) {
        super(who, menu);
     ...
     */
    public MenuItemIdentifier getItemId() {
        return itemId;
    }
