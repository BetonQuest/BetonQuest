...
import org.betonquest.betonquest.quest.condition.redstonepower.RedstonePowerConditionFactory;
...
public class ConditionTypesComponent extends AbstractCoreComponent {
    ...
    protected void load(final DependencyProvider dependencyProvider) {
        ...
        conditionTypes.registerCombined("redstonepower", new RedstonePowerConditionFactory());
