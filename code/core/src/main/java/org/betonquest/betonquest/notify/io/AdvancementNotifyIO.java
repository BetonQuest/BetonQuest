...
public class AdvancementNotifyIO extends NotifyIO {
     ...
     */
    public AdvancementNotifyIO(final PlaceholderManager placeholders, @Nullable final QuestPackage pack, final Map<String, String> data, final Plugin plugin) throws QuestException {
