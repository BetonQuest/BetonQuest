...
public class VariableObjective extends DefaultObjective {
    ...
    public static class VariableData extends ObjectiveData {
         ...
         */
        public VariableData(final String instruction, final Profile profile, final ObjectiveIdentifier objID) {
        ...
        public void add(final String key, @Nullable final String value) {
            ...
            try {
                service = BetonQuest.getInstance().getBetonQuestApi().objectives().manager().getObjective(objID).getService();
