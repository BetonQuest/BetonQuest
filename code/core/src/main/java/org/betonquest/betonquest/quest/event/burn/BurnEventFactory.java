 ...
 */
public class BurnEventFactory implements PlayerActionFactory {
    ...
    public PlayerAction parsePlayer(final Instruction instruction) throws QuestException {
        ...
        return new OnlineActionAdapter(new BurnEvent(duration), loggerFactory.create(BurnEvent.class), instruction.getPackage());
    }
}
