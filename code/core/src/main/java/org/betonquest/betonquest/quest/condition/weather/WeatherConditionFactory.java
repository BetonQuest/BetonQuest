...
public class WeatherConditionFactory implements PlayerConditionFactory, PlayerlessConditionFactory {
    ...
    public PlayerCondition parsePlayer(final Instruction instruction) throws QuestException {
        ...
        final Variable<World> world = instruction.get(instruction.getValue("world", "%location.world%"), DefaultArgumentParsers.WORLD);
    ...
    public PlayerlessCondition parsePlayerless(final Instruction instruction) throws QuestException {
        ...
        final Variable<Weather> weather = instruction.get(Weather::parseWeather);
        final Variable<World> world = new Variable<>(variables, instruction.getPackage(), worldString, DefaultArgumentParsers.WORLD);
