...
/**
 * Interface for parsing {@link InstructionIdentifierArgument}s.
 */
public interface InstructionIdentifierArgumentResolver extends Resolver {
     ...
     */
    default <T> Variable<T> get(final InstructionIdentifierArgument<T> argument) throws QuestException {
    ...
    @Nullable
    default <T> Variable<T> get(@Nullable final String string, final InstructionIdentifierArgument<T> argument) throws QuestException {
    ...
    @Nullable
    <T> Variable<T> get(@Nullable String string, InstructionIdentifierArgument<T> argument, @Nullable T defaultValue) throws QuestException;
     ...
     */
    @Nullable
    default <T> Variable<T> getValue(final String key, final InstructionIdentifierArgument<T> argument) throws QuestException {
    ...
    @Nullable
    default <T> Variable<T> getValue(final String key, final InstructionIdentifierArgument<T> argument, @Nullable final T defaultValue) throws QuestException {
     ...
     * @throws QuestException when there is no part left or the value can't be created
     */
    default <T> Variable<List<T>> getList(final InstructionIdentifierArgument<T> argument) throws QuestException {
     ...
     * @throws QuestException when there is no part left or the value can't be created
     */
    default <T> Variable<List<T>> getList(final InstructionIdentifierArgument<T> argument, final ValueChecker<List<T>> valueChecker) throws QuestException {
     ...
     * @throws QuestException when the value can't be created
     */
    default <T> Variable<List<T>> getList(@Nullable final String string, final InstructionIdentifierArgument<T> argument) throws QuestException {
     ...
     * @throws QuestException when the value can't be created
     */
    <T> Variable<List<T>> getList(@Nullable String string, InstructionIdentifierArgument<T> argument, ValueChecker<List<T>> valueChecker) throws QuestException;
     ...
     * @throws QuestException when the value can't be created
     */
    default <T> Variable<List<T>> getValueList(final String key, final InstructionIdentifierArgument<T> argument) throws QuestException {
     ...
     * @throws QuestException when the value can't be created
     */
    default <T> Variable<List<T>> getValueList(final String key, final InstructionIdentifierArgument<T> argument, final ValueChecker<List<T>> valueChecker) throws QuestException {
