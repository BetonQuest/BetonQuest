...
public class DropEvent implements NullableEvent {
     ...
     */
    public DropEvent(final Variable<List<QuestItemWrapper>> items, final Variable<Location> location) {
        this.items = items;
    ...
    public void execute(@Nullable final Profile profile) throws QuestException {
        ...
        for (final QuestItemWrapper itemDefinition : items.getValue(profile)) {
