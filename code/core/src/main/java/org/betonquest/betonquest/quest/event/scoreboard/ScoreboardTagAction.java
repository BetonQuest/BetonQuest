 ...
 */
public class ScoreboardTagAction implements OnlineAction {
     ...
     */
    public ScoreboardTagAction(final Argument<String> tag, final Argument<ScoreboardTagOperation> action) {
        this.tag = tag;
        this.action = action;
    }
