...
/**
 * An abstract class for creating Point placeholders.
 *
 * @param <T> the data holder type
 */
@SuppressWarnings("PMD.AbstractClassWithoutAbstractMethod")
public abstract class AbstractPointPlaceholder<T> {
     ...
     */
    public AbstractPointPlaceholder(final T data, final String category, final int amount, final PointCalculationType type) {
        this.data = data;
