 ...
 */
public class LogAction implements NullableAction {
     ...
     */
    public LogAction(final BetonQuestLogger logger, final Argument<LogEventLevel> level, final Argument<String> message) {
        this.logger = logger;
