...
public class Config
{
	 ...
	 */
	public static void sendMessage(String playerID, String messageName, String[] variables, String soundName, String prefixName, String[] prefixVariables)
	{
	...
	/**
	 * Sends a notification to player in his chosen language or default or
	 * English
	 * (if previous not found). It will replace all {x} sequences with the
	 * variables and play the sound. It will also add a prefix to the message.
	 *
	...
	public static String parseMessage(String playerID, String messageName, String[] variables, String prefixName, String[] prefixVariables)
	{
	 ...
	 *            array of variables which will be inserted into the prefix
	 */
	public static String parseMessage(Player player, String messageName, String[] variables, String prefixName, String[] prefixVariables)
	{
	 ...
	 * @param soundName
	 *            the name of the sound to play to the player
	 */
