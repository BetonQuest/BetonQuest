...
class RealtimeCronSchedulerTest {
    ...
    void testStartWithoutSchedules() {
        ...
        final RealtimeCronScheduler scheduler = spy(new RealtimeCronScheduler(logger, questAPI, cache));
        scheduler.start(now);
    ...
    void testStartWithRebootSchedules() {
        final LastExecutionCache cache = mock(LastExecutionCache.class);
        final RealtimeCronScheduler scheduler = new RealtimeCronScheduler(logger, questAPI, cache);
    ...
    void testStartSchedule() {
        ...
        final RealtimeCronScheduler scheduler = new RealtimeCronScheduler(logger, questAPI, () -> executorService, cache);
