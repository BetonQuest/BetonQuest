...
class RealtimeDailySchedulerTest {
    ...
    void testStartWithoutSchedules() {
        ...
        final RealtimeDailyScheduler scheduler = spy(new RealtimeDailyScheduler(logger, questAPI, cache));
        scheduler.start(now);
    ...
    void testStartWithMissedSchedulesStrategyOne() {
        ...
        final RealtimeDailyScheduler scheduler = new RealtimeDailyScheduler(logger, questAPI, () -> executorService, cache);
