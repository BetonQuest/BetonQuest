...
public class BlockObjective extends CountingObjective implements Listener {
    ...
    public BlockObjective(final Instruction instruction) throws QuestException {
        ...
        blockBreakSender = new IngameNotificationSender(instance.getLoggerFactory().create(BlockObjective.class),
                instance.getPluginMessage(), instruction.getPackage(), instruction.getID().getFullID(),
                NotificationLevel.INFO, "blocks_to_break");
        blockPlaceSender = new IngameNotificationSender(instance.getLoggerFactory().create(BlockObjective.class),
                instance.getPluginMessage(), instruction.getPackage(), instruction.getID().getFullID(),
                NotificationLevel.INFO, "blocks_to_place");
    }
