...
public class CoreQuestTypes {
    ...
    private void registerEvents(final EventTypeRegistry eventTypes) {
        ...
        eventTypes.register("deletepoint", new DeletePointEventFactory());
        eventTypes.register("door", new DoorEventFactory(data));
        ...
        eventTypes.register("explosion", new ExplosionEventFactory(data));
        eventTypes.register("folder", FolderEvent.class);
        eventTypes.register("first", new FirstEventFactory());
        ...
        eventTypes.register("globalpoint", new GlobalPointEventFactory());
        eventTypes.register("hunger", new HungerEventFactory(loggerFactory, data));
        eventTypes.register("if", new IfElseEventFactory());
        ...
        eventTypes.register("lever", new LeverEventFactory(data));
        eventTypes.register("lightning", new LightningEventFactory(data));
        eventTypes.register("log", new LogEventFactory(loggerFactory));
        ...
        eventTypes.register("pickrandom", new PickRandomEventFactory());
        eventTypes.register("point", new PointEventFactory(loggerFactory));
        eventTypes.register("removeentity", new RemoveEntityEventFactory(data));
        ...
        eventTypes.register("setblock", new SetBlockEventFactory(data));
