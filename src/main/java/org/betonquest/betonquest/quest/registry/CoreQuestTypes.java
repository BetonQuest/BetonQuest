...
public class CoreQuestTypes {
    ...
    private void registerEvents() {
        betonQuest.registerNonStaticEvent("burn", new BurnEventFactory(loggerFactory, data));
        ...
        betonQuest.registerNonStaticEvent("chat", new ChatEventFactory(loggerFactory, data));
        betonQuest.registerEvent("chestclear", new ChestClearEventFactory(data));
        betonQuest.registerEvent("chestgive", new ChestGiveEventFactory(data));
        betonQuest.registerEvent("chesttake", new ChestTakeEventFactory(data));
        ...
        betonQuest.registerNonStaticEvent("conversation", new ConversationEventFactory(loggerFactory, data));
        betonQuest.registerNonStaticEvent("damage", new DamageEventFactory(loggerFactory, data));
        betonQuest.registerNonStaticEvent("deleffect", new DeleteEffectEventFactory(loggerFactory, data));
        ...
        betonQuest.registerEvent("door", new DoorEventFactory(data));
        betonQuest.registerEvent("drop", new DropEventFactory(data));
        betonQuest.registerNonStaticEvent("effect", new EffectEventFactory(loggerFactory, data));
        betonQuest.registerNonStaticEvent("experience", new ExperienceEventFactory(loggerFactory, data));
        betonQuest.registerEvent("explosion", new ExplosionEventFactory(data));
        betonQuest.registerEvents("folder", FolderEvent.class);
        betonQuest.registerEvent("first", new FirstEventFactory());
        betonQuest.registerNonStaticEvent("give", new GiveEventFactory(loggerFactory, data));
        betonQuest.registerNonStaticEvent("givejournal", new GiveJournalEventFactory(loggerFactory, data));
        ...
        betonQuest.registerNonStaticEvent("hunger", new HungerEventFactory(loggerFactory, data));
        betonQuest.registerEvent("if", new IfElseEventFactory());
        betonQuest.registerNonStaticEvent("itemdurability", new ItemDurabilityEventFactory(loggerFactory, data));
        ...
        betonQuest.registerNonStaticEvent("kill", new KillEventFactory(loggerFactory, data));
        betonQuest.registerNonStaticEvent("language", new LanguageEventFactory(betonQuest));
        betonQuest.registerEvent("lever", new LeverEventFactory(data));
        betonQuest.registerEvent("lightning", new LightningEventFactory(data));
        betonQuest.registerEvent("log", new LogEventFactory(loggerFactory));
        betonQuest.registerNonStaticEvent("notify", new NotifyEventFactory(loggerFactory, data));
        betonQuest.registerEvent("notifyall", new NotifyAllEventFactory(loggerFactory, data));
        betonQuest.registerEvents("objective", ObjectiveEvent.class);
        betonQuest.registerNonStaticEvent("opsudo", new OpSudoEventFactory(loggerFactory, data));
        ...
        betonQuest.registerEvent("removeentity", new RemoveEntityEventFactory(data));
        ...
        betonQuest.registerEvent("setblock", new SetBlockEventFactory(data));
        betonQuest.registerNonStaticEvent("score", new ScoreboardEventFactory(data));
        ...
        betonQuest.registerNonStaticEvent("sudo", new SudoEventFactory(loggerFactory, data));
        ...
        betonQuest.registerNonStaticEvent("teleport", new TeleportEventFactory(loggerFactory, data));
        ...
        betonQuest.registerNonStaticEvent("velocity", new VelocityEventFactory(loggerFactory, data));
