...
public class TeleportEventFactory implements EventFactory {
     ...
     */
    public TeleportEventFactory(final BetonQuestLogger log, final Server server, final BukkitScheduler scheduler, final Plugin plugin) {
        this.log = log;
        this.server = server;
    ...
    public Event parseEvent(final Instruction instruction) throws InstructionParseException {
        ...
        return new PrimaryServerThreadEvent(
                new OnlineProfileRequiredEvent(
                        log, new TeleportEvent(location), instruction.getPackage()),
