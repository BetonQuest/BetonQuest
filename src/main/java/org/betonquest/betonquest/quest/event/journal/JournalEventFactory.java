...
public class JournalEventFactory implements EventFactory, StaticEventFactory {
     ...
     */
    public JournalEventFactory(final BetonQuestLoggerFactory loggerFactory, final PlayerDataStorage dataStorage, final InstantSource instantSource, final Saver saver, final ProfileProvider profileProvider) {
