...
public class PlayerHider {
    ...
    private void updateVisibilityForProfiles(final Collection<OnlineProfile> onlineProfiles, final OnlineProfile source, @Nullable final List<OnlineProfile> profilesToHide) {
