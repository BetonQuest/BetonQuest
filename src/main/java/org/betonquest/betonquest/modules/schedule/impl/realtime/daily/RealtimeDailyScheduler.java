...
public class RealtimeDailyScheduler extends ExecutorServiceScheduler<RealtimeDailySchedule, Instant> {
     ...
     */
    public RealtimeDailyScheduler(final BetonQuestLogger log, final BetonQuestAPI questAPI, final Supplier<ScheduledExecutorService> executor, final LastExecutionCache lastExecutionCache) {
     ...
     * @param lastExecutionCache cache where the last execution times of a schedule are stored
     */
    public RealtimeDailyScheduler(final BetonQuestLogger log, final BetonQuestAPI questAPI, final LastExecutionCache lastExecutionCache) {
        super(log, questAPI);
        this.log = log;
        this.lastExecutionCache = lastExecutionCache;
    }
