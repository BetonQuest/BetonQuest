...
public enum QueryType {
    ...
    LOAD_TOP_10_POINTS_ASC(prefix -> "SELECT * FROM " + prefix + "points WHERE category = ? ORDER BY count ASC LIMIT ?;"),

    LOAD_TOP_10_POINTS_DESC(prefix -> "SELECT * FROM " + prefix + "points WHERE category = ? ORDER BY count DESC LIMIT ?;");
