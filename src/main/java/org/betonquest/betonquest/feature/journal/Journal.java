...
public class Journal {
     ...
     */
    public Journal(final PluginMessage pluginMessage, final TextParser textParser,
                   final FontRegistry fontRegistry, final Profile profile, final List<Pointer> list,
