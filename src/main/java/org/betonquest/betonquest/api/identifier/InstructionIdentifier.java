...
public abstract class InstructionIdentifier extends Identifier {
     ...
     */
    protected InstructionIdentifier(final QuestPackageManager questPackageManager, @Nullable final QuestPackage pack,
    ...
    protected InstructionIdentifier(final QuestPackageManager questPackageManager, @Nullable final QuestPackage pack,
        ...
        this(questPackageManager, pack, identifier, id -> {
            ...
            return new Instruction(questPackageManager, id.getPackage(), id, rawInstruction);
        });
    }
