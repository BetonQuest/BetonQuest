...
public class EventID extends InstructionIdentifier {
     ...
     */
    public EventID(final QuestPackageManager questPackageManager, @Nullable final QuestPackage pack, final String identifier) throws QuestException {
        super(questPackageManager, pack, identifier, "events", "Event");
    }
}
