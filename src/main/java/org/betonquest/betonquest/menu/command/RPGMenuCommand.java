                    ...
                    for (final MenuID menuID : ids) {
                        builder
                                .append(Component.newline().append(Component.text(menuID.toString()).color(NamedTextColor.GRAY))
                                        ...
                                        .clickEvent(net.kyori.adventure.text.event.ClickEvent.runCommand("/" + getName() + " open " + menuID)));
                    }
                }
    ...
    private void showHelp(final CommandSender sender) {
        ...
        builder
                ...
                .append(Component.text("/rpgmenu reload [menu]").color(NamedTextColor.RED)
                        ...
                        .clickEvent(net.kyori.adventure.text.event.ClickEvent.suggestCommand("/rpgmenu reload "))
                        .append(Component.newline()))
                .append(Component.text("/rpgmenu open <menu> [player]\n").color(NamedTextColor.RED)
                        .hoverEvent(getMessage(sender, "command_info_open"))
                        .clickEvent(net.kyori.adventure.text.event.ClickEvent.suggestCommand("/rpgmenu open"))
                        .append(Component.newline()))
                .append(Component.text("/rpgmenu list").color(NamedTextColor.RED)
                        .hoverEvent(getMessage(sender, "command_info_list"))
                        .clickEvent(net.kyori.adventure.text.event.ClickEvent.suggestCommand("/rpgmenu list")));
        sender.sendMessage(builder.asComponent());
    }
}
