...
import org.betonquest.betonquest.config.patcher.migration.migrator.from2to3.MenuIOLineWrapping;
...
public class QuestMigrator {
    ...
    public QuestMigrator(final BetonQuestLogger log, final PluginDescriptionFile pluginDescription) {
        ...
        migrations.put(questVersion("3.0.0", 13), new MenuIOLineWrapping());
