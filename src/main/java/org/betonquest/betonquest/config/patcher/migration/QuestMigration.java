...
public interface QuestMigration {
     ...
     */
    void migrate(Quest quest) throws IOException;
    ...
    default boolean replaceValueInSection(final ConfigurationSection config, final String sectionName, final String typeName, final String oldValue, final String newValue) {
        final ConfigurationSection section = config.getConfigurationSection(sectionName);
        if (section == null) {
            return false;
        }
