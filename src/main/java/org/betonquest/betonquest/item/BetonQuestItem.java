 ...
 */
public class BetonQuestItem implements QuestItem {
    /**
     ...
     */
    public BetonQuestItem(final BlockSelector selector, final List<ItemMetaHandler<?>> handlers,
    ...
    public boolean equals(@Nullable final Object other) {
        return other instanceof final BetonQuestItem item && item.handlers.equals(handlers);
    }
