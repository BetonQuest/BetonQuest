...
public class ProtocolLibIntegrator implements Integrator {
    ...
    public void hook() throws HookException {
        ...
        plugin.getFeatureRegistries().conversationIO().register("menu", new MenuConvIOFactory(plugin.getMessageParser(), plugin.getFontRegistry(), plugin.getConversationColors()));
