...
import org.betonquest.betonquest.compatibility.traincarts.conditions.TrainCartsConditionFactory;
...
public class TrainCartsIntegrator implements Integrator {
    ...
    public void hook() throws HookException {
        ...
        plugin.getQuestRegistries().getConditionTypes().register("traincartsride",
                new TrainCartsConditionFactory(plugin.getLoggerFactory(), data));
    }
