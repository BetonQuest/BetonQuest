...
public class WandConditionFactory implements PlayerConditionFactory {
    ...
    public PlayerCondition parsePlayer(final Instruction instruction) throws QuestException {
        ...
        final Variable<List<Map.Entry<String, Integer>>> spells = instruction.getValueList("spells", SpellParser.SPELL, VariableList.joaNotDoubleChecker());
        final Variable<String> name = instruction.get(instruction.getValue("name"), Argument.STRING);
     ...
     */
    private static class SpellParser implements Argument<Map.Entry<String, Integer>> {
        /**
        ...
        public Map.Entry<String, Integer> apply(final String value) throws QuestException {
            ...
            return Map.entry(parts[0], Argument.NUMBER.apply(parts[1]).intValue());
        }
    }
}
