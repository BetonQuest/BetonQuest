...
public class DrunkQualityConditionFactory implements PlayerConditionFactory {
     ...
     */
    public DrunkQualityConditionFactory(final PrimaryServerThreadData data) {
        this.data = data;
    }
    ...
    public PlayerCondition parsePlayer(final Instruction instruction) throws QuestException {
        ...
        return new PrimaryServerThreadPlayerCondition(new DrunkQualityCondition(qualityVar), data);
    }
}
