...
public class MMOCoreAttributeReallocationPointsEvent extends QuestEvent {
    ...
    public MMOCoreAttributeReallocationPointsEvent(final Instruction instruction) throws InstructionParseException {
    ...
    protected Void execute(final Profile profile) throws QuestRuntimeException {
        final PlayerData data = PlayerData.get(profile.getPlayer());
