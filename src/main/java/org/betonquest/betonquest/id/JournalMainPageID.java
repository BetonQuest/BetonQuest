...
public class JournalMainPageID extends InstructionIdentifier {
     ...
     */
    public JournalMainPageID(final QuestPackageManager questPackageManager, @Nullable final QuestPackage pack, final String identifier) throws QuestException {
        super(questPackageManager, pack, identifier, "journal_main_page", "Journal Main Page");
    }
}
