...
public class JournalEntryID extends InstructionIdentifier {
     ...
     */
    public JournalEntryID(final QuestPackageManager questPackageManager, @Nullable final QuestPackage pack, final String identifier) throws QuestException {
        super(questPackageManager, pack, identifier, "journal", "Journal Entry");
    }
}
