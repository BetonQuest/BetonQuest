...
public final class Utils {
    ...
    @SuppressFBWarnings("NP_NULL_ON_SOME_PATH_FROM_RETURN_VALUE")
    public static List<OnlineProfile> getParty(final OnlineProfile profile, final double range, final String pack, final ConditionID... conditions) throws QuestRuntimeException {
        final Location loc = profile.getOnlinePlayer().getLocation();
