...
public class BetonQuest extends JavaPlugin {
    ...
    private static final HashMap<String, Class<? extends Condition>> conditionTypes = new HashMap<>();
    private static final HashMap<String, Class<? extends QuestEvent>> eventTypes = new HashMap<>();
    private static final HashMap<String, Class<? extends Objective>> objectiveTypes = new HashMap<>();
    private static final HashMap<String, Class<? extends ConversationIO>> convIOTypes = new HashMap<>();
    private static final HashMap<String, Class<? extends Interceptor>> interceptorTypes = new HashMap<>();
    private static final HashMap<String, Class<? extends NotifyIO>> notifyIOTypes = new HashMap<>();
    private static final HashMap<String, Class<? extends Variable>> variableTypes = new HashMap<>();
