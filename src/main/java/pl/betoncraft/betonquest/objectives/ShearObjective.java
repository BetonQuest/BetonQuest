...
public class ShearObjective extends Objective implements Listener {
    ...
    public void onShear(PlayerShearEntityEvent event) {
        ...
        if (name != null && (event.getEntity().getCustomName() == null || !event.getEntity().getCustomName().equals(name))) return;
        if (color != null && !((Sheep) event.getEntity()).getColor().toString().equalsIgnoreCase(color)) return;
