...
public class RaCManaCondition extends Condition {
	...
	public RaCManaCondition(String packName, String instructions) throws InstructionParseException {
	...
	public boolean check(String playerID) {
		return ManaAPI.getCurrentMana(PlayerConverter.getPlayer(playerID)) >= number;
	}
