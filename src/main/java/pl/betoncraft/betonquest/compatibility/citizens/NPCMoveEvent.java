...
/**
 * Moves the NPC to a specified location, optionally firing doneEvents when it's
 * done.
 *
...
public class NPCMoveEvent extends QuestEvent implements Listener {
	...
	/**
	 * Checks if you can talk to an npc or if it's moving because of a 'move'
	 * event and conversations are blocked
	 *
	 * @param npc
	 *            NPC to check
