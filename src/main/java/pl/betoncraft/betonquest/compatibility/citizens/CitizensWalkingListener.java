...
public class CitizensWalkingListener implements Listener {
	...
	/**
	 * @return the currently active WalkingListener or null if citizens isn't
	 *         hooked
	 */
	 ...
	 * @param npc
	 *            a npc to check for
	 * @return true if the movement of the npc is paused because of a player
	...
	/**
	 * Sets a new target location to which the npc should move when the
	 * conversations end
	 * <p>
	 * Check {@link #isMovementPaused(NPC)} before to make sure the npcs
	 * movement is currently paused
	 *
	 * @param npc
	 *            a npc
	 * @param location
	 *            the location to which the npc should move
	 */
