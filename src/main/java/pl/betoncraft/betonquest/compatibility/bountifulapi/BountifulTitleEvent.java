...
public class BountifulTitleEvent extends TitleEvent {
	...
	public BountifulTitleEvent(final Instruction instruction) throws InstructionParseException {
		super(instruction);
	}
	...
	protected Void execute(final String playerID) throws QuestRuntimeException {
		...
		for(final String variable : variables) {
			message = message.replace(variable, BetonQuest.getInstance().getVariableValue(instruction.getPackage().getName(), variable, playerID));
		}
