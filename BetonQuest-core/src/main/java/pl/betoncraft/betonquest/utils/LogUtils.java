...
public final class LogUtils {
     ...
     */
    private static final File LOG_FILE = new File(BetonQuest.getInstance().getJavaPlugin().getDataFolder(),
            "/logs/latest.log");
    ...
    public static void setupLogger() {
        ...
        try {
            ...
            final String debug = BetonQuest.getInstance().getJavaPlugin().getConfig().getString("debug");
